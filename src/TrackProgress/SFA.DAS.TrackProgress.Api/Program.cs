...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "TrackProgressOuterAPI", Version = "v1", Description = "Save the taxonomy progress for a specific apprenticeship using your existing systems." });
