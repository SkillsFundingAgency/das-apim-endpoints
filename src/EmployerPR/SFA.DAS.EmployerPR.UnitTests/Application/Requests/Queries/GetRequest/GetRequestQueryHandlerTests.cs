...
public class GetRequestQueryHandlerTests
{
    ...
    public async Task Handle_RequestFound_ReturnsRequest(
        ...
        GetRequestQueryResult expected,
    ...
    public async Task Handle_RequestNotFound_ReturnsNull(
        ...
        CancellationToken cancellationToken)
    {
        apiClientMock.Setup(c => c.GetRequest(query.RequestId, cancellationToken)).ReturnsAsync(RestEaseResponseBuilder.GetNotFoundResponse<GetRequestQueryResult>());
