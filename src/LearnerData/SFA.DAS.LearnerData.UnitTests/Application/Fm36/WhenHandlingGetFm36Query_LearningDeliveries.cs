...
public class WhenHandlingGetFm36Query_LearningDeliveries
{
    ...
    public async Task ThenALearningDeliveryIsCreatedForEachApprenticeship()
    {
        ...
        testFixture.Result.Items.Count.Should().Be(testFixture.LearningsResponse.Learnings.Count);
        testFixture.Result.Items.SelectMany(learner => learner.LearningDeliveries).Count().Should().Be(testFixture.LearningsResponse.Learnings.Count);
    }
    ...
    public async Task ThenReturnsLearningDeliveryValuesForEachApprenticeship(TestScenario scenario)
    {
        ...
        var earningApprenticeship = testFixture.EarningsResponses[scenario].Apprenticeship;
    ...
    public async Task ThenReturnsLearningSupportValues(TestScenario scenario)
    {
        ...
        var expectedLearningSupport = testFixture.EarningsResponses[scenario].Apprenticeship
            .Episodes.First()
    ...
    public async Task ThenReturnsInstPerPeriodValuesForEachApprenticeship(TestScenario scenario)
    {
        ...
        var earningEpisode = testFixture.EarningsResponses[scenario].Apprenticeship.Episodes.Single();
    ...
    public async Task ThenReturnsLearningDeliveryPeriodisedTextValuesForEachApprenticeship(TestScenario scenario)
    {
        ...
        var apprenticeship = testFixture.LearningsResponse.Learnings.Single();
        var earningsApprenticeship = testFixture.EarningsResponses[scenario].Apprenticeship;
