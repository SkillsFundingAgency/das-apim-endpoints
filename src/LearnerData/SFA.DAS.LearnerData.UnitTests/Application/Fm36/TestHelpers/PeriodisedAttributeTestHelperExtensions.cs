...
{
    internal static bool AllValuesAreSetToZero(this PeriodisedAttribute attribute)
    {
        return AllValuesAreSetTo(attribute, 0);
    }

    internal static bool AllValuesAreSetTo(this PeriodisedAttribute attribute, decimal? value)
    {
    ...
    internal static bool HasExactPeriodValues(this PeriodisedAttribute? attribute, decimal[] values)
    {
