...
public class PostOrganisationCommand : IRequest<HttpStatusCode>
{
    ...
    public static implicit operator PostOrganisationCommand(PostOrganisationRequest source) =>
        new()
        {
            ...
            RequestingUserDisplayName = source.RequestingUserDisplayName,
            DeliversApprenticeships = source.DeliversApprenticeships,
            DeliversApprenticeshipUnits = source.DeliversApprenticeshipUnits,
        };
