...
public class TryCreateMyApprenticeshipTests
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        mediatorMock.Verify(m => m.Send(It.IsAny<GetRecentCommitmentQuery>(), It.IsAny<CancellationToken>()));
        mediatorMock.Verify(m => m.Send(It.IsAny<GetStagedApprenticeQuery>(), It.IsAny<CancellationToken>()), Times.Never);
    }

    [Test]
    [MoqAutoData]
    public async Task CommitmentFound_ReturnsSuccessResult(
        [Frozen] Mock<IMediator> mediatorMock,
        [Greedy] MyApprenticeshipController sut,
        TryCreateMyApprenticeshipRequestModel model,
        GetRecentCommitmentQueryResult commitment,
    ...
    [Test]
    [MoqAutoData]
    public async Task CommitmentFound_CreatesMyApprenticeshipFromCommitments(
        [Frozen] Mock<IMediator> mediatorMock,
        [Greedy] MyApprenticeshipController sut,
        TryCreateMyApprenticeshipRequestModel model,
        GetRecentCommitmentQueryResult commitment,
    ...
    [Test]
    [MoqAutoData]
    public async Task StagedApprenticeFound_ReturnsSuccessResult(
        [Frozen] Mock<IMediator> mediatorMock,
        [Greedy] MyApprenticeshipController sut,
        TryCreateMyApprenticeshipRequestModel model,
    ...
    [Test]
    [MoqAutoData]
    public async Task StagedApprenticeFound_CreatesMyApprenticeshipFromStagedApprentice(
        [Frozen] Mock<IMediator> mediatorMock,
        [Greedy] MyApprenticeshipController sut,
        TryCreateMyApprenticeshipRequestModel model,
        GetStagedApprenticeResponse stagedApprentice,
