...
namespace SFA.DAS.RoatpCourseManagement.UnitTests.Application.UkrlpData.UkrlpSoapSerializer
{
    ...
    public class UkrlpSoapSerializerTests
    {
        ...
        public void DeserialiseMatchingProviderRecordsResponse_ReturnsMatchingRecords()
        {
            ...
            Assert.That(company1.ProviderName, Is.EqualTo("Company name 1"));
            Assert.That(company1.ProviderContacts[0].ContactAddress.Address1, Is.EqualTo("address line 1 for 1"));
            Assert.That(company1.ProviderContacts[0].ContactAddress.Address2, Is.EqualTo("address line 2 for 1")); 
            Assert.That(company1.ProviderContacts[0].ContactAddress.Address3, Is.EqualTo("address line 3 for 1")); 
            Assert.That(company1.ProviderContacts[0].ContactAddress.Address4, Is.EqualTo("address line 4 for 1")); 
            Assert.That(company1.ProviderContacts[0].ContactAddress.Town, Is.EqualTo("Town 1")); 
            Assert.That(company1.ProviderContacts[0].ContactAddress.PostCode, Is.EqualTo("Postcode 1"));
        }
    }
}
