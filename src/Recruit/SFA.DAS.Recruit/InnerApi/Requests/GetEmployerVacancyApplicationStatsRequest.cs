...
public class GetEmployerVacancyApplicationStatsRequest(long accountId, IEnumerable<long> vacancyReferences) : IGetApiRequest
{
    public string GetUrl
    {
        get
        {
            var baseUrl = $"api/employer/{accountId}/vacancies/stats";
