...
[TestFixture]
internal class WhenHandlingGetProviderPermissionsByUkprnAndAccountIdQuery
{
    [Test, MoqAutoData]
    public async Task Then_The_Query_Is_Handled_And_Data_Returned(
        ...
        GetProviderPermissionsByUkprnAndAccountIdQueryHandler handler)
    {
        // Arrange
        permissionService
            .Setup(x => x.GetProviderPermissionsForEmployerAccountLegalEntities(
                query.Ukprn,
                query.AccountId,
