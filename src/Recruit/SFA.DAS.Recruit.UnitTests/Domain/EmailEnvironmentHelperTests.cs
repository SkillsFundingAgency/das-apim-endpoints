...
public class EmailEnvironmentHelperTests
{
    ...
    public void Then_The_TemplateIds_Are_Correctly_Set_For_Production()
    {
        ...
        actual.VacacnyReviewRejectedByDfeTemplayeId.Should().Be("27acd0e9-96fe-47ec-ae33-785e00a453f8");
    ...
    public void Then_The_TemplateIds_Are_Correctly_Set_For_Non_Production()
    {
        ...
        actual.VacacnyReviewRejectedByDfeTemplayeId.Should().Be("5869140a-2a76-4a7c-b4b9-083d2afc5aa5");
