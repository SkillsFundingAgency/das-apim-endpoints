...
{
    [Test, AutoData]
    public void Then_The_Values_Are_Set_Correctly(string templateId,string recipientEmail, string advertTitle, string firstName, string vacancyReference, string employerName, string findAnApprenticeshipAdvertUrl, string notificationSettingsUrl)
    {
        ...
        var actual = new VacancyReviewResponseEmailTemplate(templateId, recipientEmail, advertTitle, firstName, employerName,findAnApprenticeshipAdvertUrl, notificationSettingsUrl, vacancyReference);
