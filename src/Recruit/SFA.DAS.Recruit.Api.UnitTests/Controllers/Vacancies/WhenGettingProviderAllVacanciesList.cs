...
public class WhenGettingProviderAllVacanciesList
{
    [Test, MoqAutoData]
        ...
        [Greedy] VacanciesController sut)
    {
        ...
        // act
        await sut.GetProviderAllVacanciesList(
            gqlClient.Object,
            apiClient.Object,
            ukprn,
            filterParams,
        ...
        [Greedy] VacanciesController sut)
    {
        ...
        // act
        var result = await sut.GetProviderAllVacanciesList(
            gqlClient.Object,
            apiClient.Object,
            ukprn,
            filterParams,
        ...
        [Greedy] VacanciesController sut)
    {
        ...
        GetProviderVacancyApplicationStatsRequest? capturedRequest = null;
        apiClient
            ...
            .Callback((IGetApiRequest request) => capturedRequest = request as GetProviderVacancyApplicationStatsRequest)
