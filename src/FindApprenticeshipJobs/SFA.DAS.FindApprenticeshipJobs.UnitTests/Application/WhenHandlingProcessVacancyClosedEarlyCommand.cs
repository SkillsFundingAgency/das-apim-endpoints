...
public class WhenHandlingProcessVacancyClosedEarlyCommand
{
    ...
    public async Task Then_The_Vacancy_With_OneLocation_Candidates_Are_Found_Emails_Sent_And_Application_Status_Updated(
        string address1,
        string address2,
        string address3,
        string address4,
    ...
    public async Task Then_The_Vacancy_With_RecruitNationally_And_The_Candidates_Are_Found_Emails_Sent_And_Application_Status_Updated(
        string address1,
        string address2,
        string address3,
        string address4,
