...
namespace SFA.DAS.EmployerDemand.UnitTests.Domain.Models
{
    ...
    {
        [Test, AutoData]
        public void Then_The_Values_Are_Set_Correctly(string recipientEmail, string employerName, string standardName, int standardLevel, string location, int numberOfApprentices)
        {
            //Arrange
            ...
            //Act
            var actual = new CreateEmployerDemandReminderEmail(recipientEmail, employerName, standardName, standardLevel, location, numberOfApprentices);
