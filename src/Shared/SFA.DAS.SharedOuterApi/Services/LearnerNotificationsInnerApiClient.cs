...
{
    public class LearnerNotificationsInnerApiClient : ILearnerNotificationsInnerApiClient<LearnerNotificationsApiConfiguration>
    {
        private readonly IInternalApiClient<LearnerNotificationsApiConfiguration> _apiClient;

        public LearnerNotificationsInnerApiClient(IInternalApiClient<LearnerNotificationsApiConfiguration> apiClient)
        {
            _apiClient = apiClient;
        }

        public Task<TResponse> Get<TResponse>(IGetApiRequest request)
            => _apiClient.Get<TResponse>(request);

        public Task<HttpStatusCode> GetResponseCode(IGetApiRequest request)
            => _apiClient.GetResponseCode(request);
