...
public class CivilServiceJobsApiClient(IInternalApiClient<CivilServiceJobsApiConfiguration> apiClient)
    : ICivilServiceJobsApiClient<CivilServiceJobsApiConfiguration>
{
