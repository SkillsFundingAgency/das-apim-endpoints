...
namespace SFA.DAS.SharedOuterApi.Services
{
    ...
    {
        private readonly ILepsLaExternalApiClient<LepsLaApiConfiguration> _apiClient;

        public LepsLaApiClient(ILepsLaExternalApiClient<LepsLaApiConfiguration> apiClient)
        {
