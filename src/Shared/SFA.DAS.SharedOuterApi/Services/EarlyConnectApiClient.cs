...
{
    public class EarlyConnectApiClient : IEarlyConnectApiClient<EarlyConnectApiConfiguration>
    {
        private readonly IInternalApiClient<EarlyConnectApiConfiguration> _apiClient;

        public EarlyConnectApiClient(IInternalApiClient<EarlyConnectApiConfiguration> apiClient)
        {
