...
{
    public class EmployerProfilesApiClient : IEmployerProfilesApiClient<EmployerProfilesApiConfiguration>
    {
        private readonly IInternalApiClient<EmployerProfilesApiConfiguration> _apiClient;

        public EmployerProfilesApiClient(IInternalApiClient<EmployerProfilesApiConfiguration> apiClient)
        {
