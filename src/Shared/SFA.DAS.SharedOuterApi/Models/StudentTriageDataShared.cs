...
{
    public class StudentTriageDataShared
    {
        ...
        public ICollection<SurveyQuestionsDtoShared> SurveyQuestions { get; set; }
        public StudentSurveyDtoShared StudentSurvey { get; set; }
    }
}
