...
namespace SFA.DAS.SharedOuterApi.Types.UnitTests.Infrastructure.HealthCheck
{
    public class WhenCheckingHealthOnLearnerNotificationsApiClient
    {
        [Test, MoqAutoData]
        public async Task Then_The_Ping_Endpoint_Is_Called(
            [Frozen] Mock<ILearnerNotificationsInnerApiClient<LearnerNotificationsApiConfiguration>> client,
            HealthCheckContext healthCheckContext,
            LearnerNotificationsApiHealthCheck healthCheck)
        {
            // Act
        ...
        {
            LearnerNotificationsApiHealthCheck.HealthCheckResultDescription.Should().Be(LearnerNotificationsApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}