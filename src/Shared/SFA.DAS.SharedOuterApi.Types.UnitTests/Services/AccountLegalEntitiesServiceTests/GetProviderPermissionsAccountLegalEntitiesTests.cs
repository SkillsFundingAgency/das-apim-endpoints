...
[TestFixture]
internal class GetProviderPermissionsAccountLegalEntitiesTests
{
    [Test, MoqAutoData]
    public async Task GetProviderPermissionsAccountLegalEntities_Should_Return_Mapped_Legal_Entities(
        int ukprn,
        ...
        AccountLegalEntityPermissionService service)
    {
        ...
        // Act
        var result = await service.GetProviderPermissionsAccountLegalEntities(
            ukprn,
            operations);
    ...
    [Test, MoqAutoData]
    public async Task GetProviderPermissionsAccountLegalEntities_Should_Return_Empty_List_When_Response_Is_Null(int ukprn,
        List<Operation> operations,
        GetProviderAccountLegalEntitiesResponse apiResponse,
        [Frozen] Mock<IProviderRelationshipsApiClient<ProviderRelationshipsApiConfiguration>> providerRelationshipsApiClientMock,
        AccountLegalEntityPermissionService service)
    ...
    [Test, MoqAutoData]
    public async Task GetProviderPermissionsAccountLegalEntities_Should_Return_Empty_List_When_AccountProviderLegalEntities_Is_Null(int ukprn,
        List<Operation> operations,
        GetProviderAccountLegalEntitiesResponse apiResponse,
        [Frozen] Mock<IProviderRelationshipsApiClient<ProviderRelationshipsApiConfiguration>> providerRelationshipsApiClientMock,
        AccountLegalEntityPermissionService service)
