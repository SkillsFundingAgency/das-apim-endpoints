...
[TestFixture]
internal class GetProviderPermissionsForEmployerAccountLegalEntitiesTests
{
    [Test, MoqAutoData]
    public async Task GetProviderPermissionsForEmployerAccountLegalEntities_Should_Return_Mapped_Legal_Entities(
        int ukprn,
        long accountId,
    ...
    {
        // Arrange
        foreach (var entity in apiResponse.AccountProviderLegalEntities)
        {
        ...
        // Act
        var result = await service.GetProviderPermissionsForEmployerAccountLegalEntities(
            ukprn,
            accountId,
            operations);
    ...
    [Test, MoqAutoData]
    public async Task GetProviderPermissionsForEmployerAccountLegalEntities_Should_Return_Empty_List_When_Response_Is_Null(int ukprn,
        long accountId,
        List<Operation> operations,
        GetProviderAccountLegalEntitiesResponse apiResponse,
        [Frozen] Mock<IProviderRelationshipsApiClient<ProviderRelationshipsApiConfiguration>> providerRelationshipsApiClientMock,
    ...
    [Test, MoqAutoData]
    public async Task GetProviderPermissionsForEmployerAccountLegalEntities_Should_Return_Empty_List_When_AccountProviderLegalEntities_Is_Null(int ukprn,
        long accountId,
        List<Operation> operations,
        GetProviderAccountLegalEntitiesResponse apiResponse,
        [Frozen] Mock<IProviderRelationshipsApiClient<ProviderRelationshipsApiConfiguration>> providerRelationshipsApiClientMock,
