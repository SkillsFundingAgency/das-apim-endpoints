...
public class ProviderAccountApiClient(IInternalApiClient<ProviderAccountApiConfiguration> apiClient)
    : IProviderAccountApiClient<ProviderAccountApiConfiguration>
{
