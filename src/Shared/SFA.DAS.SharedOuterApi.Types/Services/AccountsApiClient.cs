...
public class AccountsApiClient(IInternalApiClient<AccountsConfiguration> client)
    : IAccountsApiClient<AccountsConfiguration>
{
    ...
    {
        return client.PostWithResponseCode<TData, TResponse>(request, includeResponse);
    }
    ...
    {
        return client.PutWithResponseCode<TResponse>(request);
    }
