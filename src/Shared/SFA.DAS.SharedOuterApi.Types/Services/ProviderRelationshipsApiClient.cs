...
public class ProviderRelationshipsApiClient(IInternalApiClient<ProviderRelationshipsApiConfiguration> apiClient)
    : IProviderRelationshipsApiClient<ProviderRelationshipsApiConfiguration>
{
