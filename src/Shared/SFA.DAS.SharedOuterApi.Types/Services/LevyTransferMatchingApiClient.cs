...
public class LevyTransferMatchingApiClient(IInternalApiClient<LevyTransferMatchingApiConfiguration> client)
    : ILevyTransferMatchingApiClient<LevyTransferMatchingApiConfiguration>
{
