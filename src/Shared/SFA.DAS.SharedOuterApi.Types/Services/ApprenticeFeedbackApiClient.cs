...
public class ApprenticeFeedbackApiClient(IInternalApiClient<ApprenticeFeedbackApiConfiguration> apiClient)
    : IApprenticeFeedbackApiClient<ApprenticeFeedbackApiConfiguration>
{
