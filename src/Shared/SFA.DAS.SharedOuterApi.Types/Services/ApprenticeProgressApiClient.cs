...
public class ApprenticeProgressApiClient(IInternalApiClient<ApprenticeProgressApiConfiguration> apiClient)
    : IApprenticeProgressApiClient<ApprenticeProgressApiConfiguration>
{
    ...
    {
        return apiClient.Post<TData>(request);
    }
