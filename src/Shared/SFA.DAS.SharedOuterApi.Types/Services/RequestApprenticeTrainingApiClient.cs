...
public class RequestApprenticeTrainingApiClient(IInternalApiClient<RequestApprenticeTrainingApiConfiguration> apiClient)
    : IRequestApprenticeTrainingApiClient<RequestApprenticeTrainingApiConfiguration>
{
    ...
    {
        return apiClient.GetPaged<TResponse>(request);
    }
    ...
    {
        return apiClient.PostWithResponseCode<TData, TResponse>(request, includeResponse);
    }
