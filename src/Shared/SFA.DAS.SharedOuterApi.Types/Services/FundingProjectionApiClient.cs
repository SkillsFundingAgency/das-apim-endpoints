...
public class FundingProjectionApiClient(IInternalApiClient<FundingProjectionApiConfiguration> client) : IFundingProjectionApiClient<FundingProjectionApiConfiguration>
{
