...
public class ApprenticeAccountsApiClient(IInternalApiClient<ApprenticeAccountsApiConfiguration> apiClient)
    : IApprenticeAccountsApiClient<ApprenticeAccountsApiConfiguration>
{
