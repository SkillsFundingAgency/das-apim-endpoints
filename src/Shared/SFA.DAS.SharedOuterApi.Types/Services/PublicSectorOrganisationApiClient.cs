...
public class PublicSectorOrganisationApiClient(IInternalApiClient<PublicSectorOrganisationApiConfiguration> client)
    : IPublicSectorOrganisationApiClient<PublicSectorOrganisationApiConfiguration>
{
