...
public class ProviderFeedbackApiClient(IInternalApiClient<ProviderFeedbackApiConfiguration> apiClient)
    : IProviderFeedbackApiClient<ProviderFeedbackApiConfiguration>
{
