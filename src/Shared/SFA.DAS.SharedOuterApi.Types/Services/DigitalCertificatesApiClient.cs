...
public class DigitalCertificatesApiClient(IInternalApiClient<DigitalCertificatesApiConfiguration> apiClient)
    : IDigitalCertificatesApiClient<DigitalCertificatesApiConfiguration>
{
