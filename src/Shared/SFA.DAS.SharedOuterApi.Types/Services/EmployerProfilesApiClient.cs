...
public class EmployerProfilesApiClient(IInternalApiClient<EmployerProfilesApiConfiguration> apiClient)
    : IEmployerProfilesApiClient<EmployerProfilesApiConfiguration>
{
