...
public class FindApprenticeshipApiClient(IInternalApiClient<FindApprenticeshipApiConfiguration> apiClient)
    : IFindApprenticeshipApiClient<FindApprenticeshipApiConfiguration>
{
