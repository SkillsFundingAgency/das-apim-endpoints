...
public class EmployerFeedbackApiClient(IInternalApiClient<EmployerFeedbackApiConfiguration> apiClient)
    : IEmployerFeedbackApiClient<EmployerFeedbackApiConfiguration>
{
