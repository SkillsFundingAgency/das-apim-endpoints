...
public class ProviderPaymentEventsApiClient(IInternalApiClient<ProviderEventsConfiguration> apiClient)
    : IProviderPaymentEventsApiClient<ProviderEventsConfiguration>
{
