...
public class FinanceApiClient(IInternalApiClient<FinanceApiConfiguration> client)
    : IFinanceApiClient<FinanceApiConfiguration>
{
    ...
    {
        return client.PostWithResponseCode<TResponse>(request);
    }
