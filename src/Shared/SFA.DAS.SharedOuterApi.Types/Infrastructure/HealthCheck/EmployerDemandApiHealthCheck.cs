...
public class EmployerDemandApiHealthCheck(
    IEmployerDemandApiClient<EmployerDemandApiConfiguration> client,
    ILogger<EmployerDemandApiHealthCheck> logger)
    : ApiHealthCheck<EmployerDemandApiConfiguration>(HealthCheckDescription, HealthCheckResultDescription, client,
        logger), IHealthCheck
{
