namespace SFA.DAS.SharedOuterApi.Types.Models.RoatpV2;
...
public class Provider
{
    ...
    public static explicit operator Provider(InnerApi.Responses.RoatpV2.Provider source)
    {
        ...
        return new Provider
        {
            ...
            Address = (ProviderAddress)source.Address
        };
    }
}