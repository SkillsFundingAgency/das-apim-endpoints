...
namespace SFA.DAS.SharedOuterApi.UnitTests.Infrastructure.InternalApi
{
    public class WhenCallingGetWithResponseCode
    {
            ...
            TestInternalApiConfiguration config)
        {
            ...
            var actualClient = new InternalApiClient<TestInternalApiConfiguration>(clientFactory.Object, config, azureClientCredentialHelper.Object, Mock.Of<ILogger<InternalApiClient<TestInternalApiConfiguration>>>());
            ...
            TestInternalApiConfiguration config)
        {
            ...
            var clientFactory = new Mock<IHttpClientFactory>();
            clientFactory.Setup(_ => _.CreateClient(It.IsAny<string>())).Returns(client);
            var actual = new InternalApiClient<TestInternalApiConfiguration>(clientFactory.Object, config, azureClientCredentialHelper.Object, Mock.Of<ILogger<InternalApiClient<TestInternalApiConfiguration>>>());
