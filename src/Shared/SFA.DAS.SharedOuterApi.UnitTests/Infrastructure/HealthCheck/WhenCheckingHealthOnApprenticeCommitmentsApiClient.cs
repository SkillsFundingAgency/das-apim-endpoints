...
{
    public class WhenCheckingHealthOnApprenticeCommitmentsApiClient
    {
        [Test, MoqAutoData]
        ...
        {
            ApprenticeCommitmentsApiHealthCheck.HealthCheckResultDescription.Should().Be(ApprenticeCommitmentsApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}