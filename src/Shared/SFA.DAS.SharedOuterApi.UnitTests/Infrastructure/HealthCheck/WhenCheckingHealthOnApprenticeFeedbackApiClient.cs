...
{
    public class WhenCheckingHealthOnApprenticeFeedbackApiClient
    {
        [Test, MoqAutoData]
        public async Task Then_The_Ping_Endpoint_Is_Called(
            [Frozen] Mock<IApprenticeFeedbackApiClient<ApprenticeFeedbackApiConfiguration>> client,
            HealthCheckContext healthCheckContext,
            ApprenticeFeedbackApiHealthCheck healthCheck)
        {
            // Act
        ...
        {
            ApprenticeFeedbackApiHealthCheck.HealthCheckResultDescription.Should().Be(ApprenticeFeedbackApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}