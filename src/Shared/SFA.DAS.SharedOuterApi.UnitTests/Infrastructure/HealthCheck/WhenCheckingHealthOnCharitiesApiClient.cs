...
{
    public class WhenCheckingHealthOnCharitiesApiClient
    {
        [Test, MoqAutoData]
        public async Task Then_The_Ping_Endpoint_Is_Called(
            [Frozen] Mock<ICharitiesApiClient<CharitiesApiConfiguration>> client,
        ...
        {
            CharitiesApiHealthCheck.HealthCheckResultDescription.Should().Be(CharitiesApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}