...
{
    public class WhenCheckingHealthOnApprenticeProgressApi
    {
        [Test, MoqAutoData]
        public async Task Then_The_Ping_Endpoint_Is_Called(
            [Frozen] Mock<IApprenticeProgressApiClient<ApprenticeProgressApiConfiguration>> client,
            HealthCheckContext healthCheckContext,
            ApprenticeProgressApiHealthCheck healthCheck)
        {
            // Act
        ...
        {
            ApprenticeProgressApiHealthCheck.HealthCheckResultDescription.Should().Be(ApprenticeProgressApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}