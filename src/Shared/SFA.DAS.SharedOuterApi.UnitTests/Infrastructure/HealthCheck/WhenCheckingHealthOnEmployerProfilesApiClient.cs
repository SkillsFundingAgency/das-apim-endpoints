...
{
    public class WhenCheckingHealthOnEmployerProfilesApiClient
    {
        [Test, MoqAutoData]
        public async Task Then_The_Ping_Endpoint_Is_Called(
            [Frozen] Mock<IEmployerProfilesApiClient<EmployerProfilesApiConfiguration>> client,
            HealthCheckContext healthCheckContext,
            EmployerProfilesApiHealthCheck healthCheck)
        {
            // Act
        ...
        {
            EmployerProfilesApiHealthCheck.HealthCheckResultDescription.Should().Be(EmployerProfilesApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}