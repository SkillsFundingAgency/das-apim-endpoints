...
{
    public class WhenCheckingHealthOnEmployerDemandApiClient
    {
        [Test, MoqAutoData]
        ...
        {
            EmployerDemandApiHealthCheck.HealthCheckResultDescription.Should().Be(EmployerDemandApiHealthCheck.HealthCheckDescription + " check");
        }
    }
}