...
namespace SFA.DAS.SharedOuterApi.UnitTests.InnerApi.Requests
{
    ...
    {
        [Test, AutoData]
        public void Then_The_Request_Is_Built_And_Data_Passed(string userRef, string email, string firstName, string lastName)
        {
            var actual = new PutAccountUserRequest(userRef, email, firstName, lastName);
