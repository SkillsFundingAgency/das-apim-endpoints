...
{
    public class WhenCallingPingOnTheApprenticeCommitmentsApiClient
    {
        [Test, MoqAutoData]
        public async Task Then_The_Ping_Endpoint_Is_Called_For_ApprenticeCommitmentsApi(
            [Frozen] Mock<IApprenticeCommitmentsApiClient<ApprenticeCommitmentsApiConfiguration>> client,
            HealthCheckContext healthCheckContext,
            ApprenticeCommitmentsApiHealthCheck healthCheck)
        {
            //Act
        ...
        [Test, MoqAutoData]
        public async Task And_ApprenticeCommitmentsApi_Ping_Not_Found_Then_Unhealthy(
            [Frozen] Mock<IApprenticeCommitmentsApiClient<ApprenticeCommitmentsApiConfiguration>> client,
            HealthCheckContext healthCheckContext,
            ApprenticeCommitmentsApiHealthCheck healthCheck)
        {
