    ...
    public static class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Contains("--h"))
            {
                ...
                Console.WriteLine("SFA.DAS.DigitalCertificates.MockApis --h                 <-- shows this page");
                Console.WriteLine("SFA.DAS.DigitalCertificates.MockApis !assessor           <-- excludes fake assessor api");
            ...
            try
            {
                ...
                {
                    _fakeRatApi = DigitalCertificatesInnerApiBuilder.Create(PortAssessorApi)
                        .WithPing()
                        .Build();
                }
