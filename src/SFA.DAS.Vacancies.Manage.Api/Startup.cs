...
namespace SFA.DAS.Vacancies.Manage.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "recruitment-api-live", Version = "v1", Description = "Create an advert on any website and Find an Apprenticeship. Give the key and {{this link to the API Page|recruitment_api_doc}} to your developer."});
            });
        }
