...
//public class AddLearnerDataCommandHandlerNew(IInternalApiClient<LearnerDataInnerApiConfiguration> client, IInternalApiClient<CoursesApiConfiguration> coursesClient, ILogger<AddLearnerDataCommandHandler> logger)
