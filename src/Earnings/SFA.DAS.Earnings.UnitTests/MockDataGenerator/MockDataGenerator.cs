            ...
            var earningsApprenticeship = new SharedOuterApi.InnerApi.Responses.Earnings.Apprenticeship
            {
                ...
                Episodes = new List<SharedOuterApi.InnerApi.Responses.Earnings.Episode>
                {
                    new SharedOuterApi.InnerApi.Responses.Earnings.Episode
                    {
                        ...
                        {
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 6, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920,6), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 7, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920,7), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 8, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920,8),InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 9, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920,9), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 10, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920, 10), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 11, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920, 11), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 1920, DeliveryPeriod = 12, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(1920, 12) , InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 1, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(2021, 1), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 2, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(2021, 2), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 3, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(2021, 3), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 4, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(2021, 4), InstalmentType = "Regular" },
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 5, Amount = 1000, EpisodePriceKey = simpleApprenticeship.GetEpisodePriceKey(2021, 5), InstalmentType = "Regular" }
                        },
            ...
            var earnings = new SharedOuterApi.InnerApi.Responses.Earnings.Apprenticeship
            {
                ...
                Episodes = new List<SharedOuterApi.InnerApi.Responses.Earnings.Episode>
                {
                    new SharedOuterApi.InnerApi.Responses.Earnings.Episode
                    {
                        ...
                        Instalments = new List<Instalment>
                        {
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 1, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,1), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 2, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,2), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 3, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,3), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 4, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,4), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 5, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,5), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 6, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,6), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 7, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,7), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 8, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,8), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 9, Amount = 1500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,9), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 10, Amount = 3500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,10), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 11, Amount = 3500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,11), InstalmentType = "Regular"},
                            new Instalment{ AcademicYear = 2021, DeliveryPeriod = 12, Amount = 3500 , EpisodePriceKey = apprenticeshipWithAPriceChange.GetEpisodePriceKey(2021,12), InstalmentType = "Regular"}
                        },
                        AdditionalPayments = new List<AdditionalPayment>
                        {
                            //Provider incentives
