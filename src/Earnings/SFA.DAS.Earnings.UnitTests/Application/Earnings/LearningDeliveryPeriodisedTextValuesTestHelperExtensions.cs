...
public static class LearningDeliveryPeriodisedTextValuesTestHelperExtensions
{
    public static bool AllValuesAreSetTo(this LearningDeliveryPeriodisedTextValues attribute, string? value)
    {
