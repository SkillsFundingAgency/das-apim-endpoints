...
{    
    public class WhenSendingBankDetailsReminderEmail
    {
        [Test, MoqAutoData]
        ...
        {
            var controllerResult = await controller.SendBankDetailsReminderEmail(sendEmailRequest) as OkResult;
            ...
            mockMediator
                .Verify(mediator => mediator.Send(
                    It.Is<SendBankDetailsReminderEmailCommand>(c =>
