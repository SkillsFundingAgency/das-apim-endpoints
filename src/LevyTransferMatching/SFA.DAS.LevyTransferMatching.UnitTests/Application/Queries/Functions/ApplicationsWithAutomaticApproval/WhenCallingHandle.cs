...
namespace SFA.DAS.LevyTransferMatching.UnitTests.Application.Queries.Functions.ApplicationsWithAutomaticApproval
{
    ...
    public class WhenCallingHandle
    {
        ...
        public async Task Handle_With_DelayedAutoApprovalChoice_ReturnsExpectedResult()
        {
            ...
            {
                new GetApplicationsResponse.Application { PledgeId = 1, Amount = 1000, PledgeRemainingAmount = 1000, MatchPercentage = 100, AutomaticApprovalOption = GetApplicationsResponse.AutomaticApprovalOption.DelayedAutoApproval, CreatedOn = DateTime.Now.AddDays(-50) },
                new GetApplicationsResponse.Application { PledgeId = 1, Amount = 500, PledgeRemainingAmount = 1000,MatchPercentage = 100, AutomaticApprovalOption = GetApplicationsResponse.AutomaticApprovalOption.DelayedAutoApproval, CreatedOn = DateTime.Now.AddDays(-50) },
                new GetApplicationsResponse.Application { PledgeId = 2, Amount = 500, PledgeRemainingAmount = 600, MatchPercentage = 100, AutomaticApprovalOption = GetApplicationsResponse.AutomaticApprovalOption.DelayedAutoApproval, CreatedOn = DateTime.Now.AddDays(-50) },
                new GetApplicationsResponse.Application {PledgeId = 2, Amount = 300, PledgeRemainingAmount = 600, MatchPercentage = 100, AutomaticApprovalOption = GetApplicationsResponse.AutomaticApprovalOption.DelayedAutoApproval, CreatedOn = DateTime.Now.AddDays(-50)},
                new GetApplicationsResponse.Application {PledgeId = 3, Amount = 300, PledgeRemainingAmount = 600, MatchPercentage = 100, AutomaticApprovalOption = GetApplicationsResponse.AutomaticApprovalOption.DelayedAutoApproval, CreatedOn = DateTime.Now.AddDays(-10)}
            };
