...
namespace SFA.DAS.LevyTransferMatching.Application.Queries.Pledges.GetApplications
{
    public class PledgeApplication
    {
        ...
        public static PledgeApplication BuildApplication(GetApplicationsResponse.Application application, Pledge pledgeResponse)
        {
            return new PledgeApplication
            {
                Id = application.Id,
        ...
        public static implicit operator PledgeApplication(GetApplicationsResponse.Application x)
        {
            return new PledgeApplication
            {
                Id = x.Id,
