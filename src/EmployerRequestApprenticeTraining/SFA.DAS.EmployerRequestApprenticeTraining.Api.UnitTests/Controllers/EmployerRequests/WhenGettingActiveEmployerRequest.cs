...
{
    public class WhenGettingActiveEmployerRequest
    {
        [Test, MoqAutoData]
           ...
           [Greedy] EmployerRequestsController controller)
        {
            ...
            var actual = await controller.GetActiveEmployerRequest(accountId, standardReference) as ObjectResult;
            ...
            [Greedy] EmployerRequestsController controller)
        {
            ...
            var actual = await controller.GetActiveEmployerRequest(accountId, standardReference) as StatusCodeResult;
