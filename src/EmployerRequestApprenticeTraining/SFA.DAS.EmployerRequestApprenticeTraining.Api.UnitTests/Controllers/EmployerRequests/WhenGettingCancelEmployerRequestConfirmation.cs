...
{
    public class WhenGettingCancelEmployerRequestConfirmation
    {

        [Test, MoqAutoData]
        public async Task Then_The_CancelEmployerRequestConfirmation_Is_Returned_From_Mediator(
            ...
            [Greedy] EmployerRequestsController controller)
        {
            ...
            var actual = await controller.GetCancelEmployerRequestConfirmation(employerRequestId) as ObjectResult;
            ...
            actual.Value.Should().BeEquivalentTo(new CancelEmployerRequestConfirmation
            {
                ...
                CancelledByEmail = profileUserResult.Email,
            ...
            [Greedy] EmployerRequestsController controller)
        {
            ...
            var actual = await controller.GetCancelEmployerRequestConfirmation(employerRequestId) as NotFoundResult;
            ...
            [Greedy] EmployerRequestsController controller)
        {
            ...
            var actual = await controller.GetCancelEmployerRequestConfirmation(employerRequestId) as StatusCodeResult;
