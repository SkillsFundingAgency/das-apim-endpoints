...
using SFA.DAS.Admin.Api.AppStart;
...
namespace SFA.DAS.Admin.Api
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                opt.SwaggerDoc("v1", new OpenApiInfo { Title = "AdminOuterApi", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "AdminOuterApi");
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "api/{controller=UserActions}/{action=index}/{id?}");
            });
        }
    }
}
