...
{
    public class ApprenticeApprenticeArticlesRequestTests
    {
        [Test, AutoData]
        public void TestUrlIsCorrectlyBuilt()
        {
            var apprenticeId = "8e5482b2-1c77-4143-80a5-ee3ddc751075";
            var instance = new GetApprenticeArticlesRequest(new Guid(apprenticeId));

            instance.GetUrl.Should().Be($"apprentices/8e5482b2-1c77-4143-80a5-ee3ddc751075/articles");
        }
    }
}
