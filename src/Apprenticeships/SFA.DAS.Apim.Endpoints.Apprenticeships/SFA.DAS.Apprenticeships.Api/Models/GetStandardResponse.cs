...
namespace SFA.DAS.Apprenticeships.Api.Models
{
    public class GetStandardResponse
    {
        ...
        //public List<GetStandardFundingResponse> ApprenticeshipFunding { get; set; } //todo commented out to allow deployment work to start
        public string StandardPageUrl { get; set; }

        //public static implicit operator GetStandardResponse(GetStandardsListItem source) //todo commented out to allow deployment work to start
        //{
