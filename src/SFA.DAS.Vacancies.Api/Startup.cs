...
namespace SFA.DAS.Vacancies.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Display advert API", Version = "v1", Description = "Display recruitment adverts from Find an apprenticeship. \n\n **Note.** It is not recommended to use the The Display Advert API directly from a browser and as such we have not enabled CORS for this API.  Instead, we recommend you call the API intermittently to retrieve the latest vacancies, stores those vacancies in your own data store, and then change your website to read those vacancies from your own data store."});
