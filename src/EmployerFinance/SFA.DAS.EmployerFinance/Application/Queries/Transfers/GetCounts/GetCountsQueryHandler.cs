...
namespace SFA.DAS.EmployerFinance.Application.Queries.Transfers.GetCounts
{
    public class GetCountsQueryHandler : IRequestHandler<GetCountsQuery, GetCountsQueryResult>
    {
        ...
        public GetCountsQueryHandler(ILevyTransferMatchingApiClient<LevyTransferMatchingApiConfiguration> levyTransferMatchingApiClient, IForecastingApiClient<ForecastingApiConfiguration> forecastingApiClient)
        {
