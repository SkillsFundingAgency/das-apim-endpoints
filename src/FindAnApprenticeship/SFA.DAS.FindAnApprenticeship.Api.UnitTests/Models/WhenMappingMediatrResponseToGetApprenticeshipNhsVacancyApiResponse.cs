...
{
    public class WhenMappingMediatrResponseToGetApprenticeshipNhsVacancyApiResponse
    {
        [Test, AutoData]
        public void Then_The_Fields_Are_Correctly_Mapped(GetVacancyDetailsQueryResult source)
        {
            var result = (GetApprenticeshipNhsVacancyApiResponse)source;
