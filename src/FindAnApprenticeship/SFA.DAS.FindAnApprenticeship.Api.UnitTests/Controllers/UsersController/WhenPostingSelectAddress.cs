...
public class WhenPostingSelectAddress
{
    ...
    {
        var actual = await controller.SelectAddress(govUkIdentifier, model) as OkObjectResult;
        ...
        [Greedy] Api.Controllers.UsersController controller)
    {
        ...
        var actual = await controller.SelectAddress(govUkIdentifier, model) as StatusCodeResult;
