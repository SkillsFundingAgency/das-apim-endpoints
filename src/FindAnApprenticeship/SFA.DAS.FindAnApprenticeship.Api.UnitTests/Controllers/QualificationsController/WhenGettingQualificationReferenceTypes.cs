...
public class WhenGettingQualificationReferenceTypes
{
        ...
        [Greedy]Api.Controllers.QualificationsController controller)
    {
        ...
        var actual = await controller.GetAddSelectType(applicationId) as OkObjectResult;
        ...
        [Greedy]Api.Controllers.QualificationsController controller)
    {
        ...
        var actual = await controller.GetAddSelectType(applicationId) as StatusCodeResult;
