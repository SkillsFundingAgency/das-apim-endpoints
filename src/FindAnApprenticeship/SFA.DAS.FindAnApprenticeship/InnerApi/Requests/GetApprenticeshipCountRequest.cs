...
namespace SFA.DAS.FindAnApprenticeship.InnerApi.Requests
{
    ...
    : IGetApiRequest
    {
        ...
        public string GetUrl =>
            $"/api/vacancies/count?lat={lat}&lon={lon}&distanceInMiles={distance}&sort={sort}&pageNumber={pageNumber}&pageSize={pageSize}&categories={_categories}&levels={_levels}&searchTerm={searchTerm}&disabilityConfident={disabilityConfident}&wageType={wageType}";
    }
}