...
public class GetDeleteTrainingCourseApiResponse
{
    ...
    public static implicit operator GetDeleteTrainingCourseApiResponse(GetDeleteTrainingCourseQueryResult source)
    {
        return new GetDeleteTrainingCourseApiResponse
        {
