...
public class DfeUsersServiceTests
{
    ...
    private Mock<ILogger<DfeUsersService>> _loggerMock;
    ...
    public void SetUp()
    {
        ...
        _loggerMock = new Mock<ILogger<DfeUsersService>>();

        var cfg = new DfeSignInApiConfiguration
        {
            Url = "https://test-signin.example.com",
            Audience = "test-audience",
            ClientId = "test-client",
            ApiSecret = "secret", // not used by service directly
            QfauUkprn = "12345678"
        };

        _sut = new DfeUsersService(_clientMock.Object,cfg,  _loggerMock.Object);
    }
