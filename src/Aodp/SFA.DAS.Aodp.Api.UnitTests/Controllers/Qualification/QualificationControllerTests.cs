...
namespace SFA.DAS.Aodp.Api.UnitTests.Controllers.Qualification
{
    ...
    public class QualificationsControllerTests
    {
        ...
        [Test]
        public async Task GetQualificationCSVExportData_ReturnsOkResult_WithExportData()
        {
            // Arrange
            ...
            // Act
            var result = await controller.GetQualificationCSVExportData("new");

            // Assert
            Assert.That(result, Is.InstanceOf<OkObjectResult>());
            var okResult = (OkObjectResult)result;
            Assert.That(okResult.Value, Is.AssignableFrom<BaseMediatrResponse<GetNewQualificationsCsvExportResponse>>());
        }
        ...
        public async Task GetQualificationVersionsForQualificationByReference_ReturnsOkResult_WithVersions()
        {
            ...
            Assert.That(result, Is.InstanceOf<OkObjectResult>());
            var okResult = (OkObjectResult)result;
            Assert.That(okResult.Value, Is.AssignableFrom<BaseMediatrResponse<GetQualificationVersionsForQualificationByReferenceQueryResponse>>());
        }
