...
{
    public class GetLearnersForProviderRequest(long providerId, string filter, string sortColumn, bool sortDescending, int page, int? pagesize, int? startMonth, int startYear, DateTime? maxStartDate, string excludeUlns, string courseCode) : IGetApiRequest
    {
