...
namespace SFA.DAS.Approvals.Api.Controllers
{
    [ApiController]
    [Route("[controller]/")]
    public class SelectMultipleController : Controller
    {
        private readonly ILogger<SelectMultipleController> _logger;
        private readonly IMediator _mediator;

        public SelectMultipleController(ILogger<SelectMultipleController> logger,
            IMediator mediator)
        {
            _logger = logger;
            _mediator = mediator;
