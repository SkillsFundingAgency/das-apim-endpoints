...
namespace SFA.DAS.Approvals.Api.Models.DraftApprenticeships
{
    public class GetAddDraftApprenticeshipCourseResponse
    {
        ...
        public static implicit operator GetAddDraftApprenticeshipCourseResponse(GetAddDraftApprenticeshipCourseQueryResult source)
        {
            return new GetAddDraftApprenticeshipCourseResponse
            {
