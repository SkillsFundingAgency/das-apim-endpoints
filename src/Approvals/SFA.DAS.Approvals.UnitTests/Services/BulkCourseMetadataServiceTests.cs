...
public class BulkCourseMetadataServiceTests
{
        ...
        int otjHours2)
    {
        ...
        var course = new GetStandardsListItem();

        courseTypeRulesService
            .Setup(x => x.GetRplRulesAsync(courseCode1))
            .ReturnsAsync(new RplRulesResult { Standard = course, RplRules = rplResponse1 });

        courseTypeRulesService
            .Setup(x => x.GetRplRulesAsync(courseCode2))
            .ReturnsAsync(new RplRulesResult { Standard = course, RplRules = rplResponse2 });
        ...
        string courseCode)
    {
        ...
        .Setup(x => x.GetRplRulesAsync(courseCode))
            .ReturnsAsync(new RplRulesResult { Standard = course, RplRules = null });
        ...
        int otjHours)
    {
        ...
        courseTypeRulesService
            .Setup(x => x.GetRplRulesAsync(courseCode))
            .ReturnsAsync(new RplRulesResult { Standard = course, RplRules = rplResponse });
