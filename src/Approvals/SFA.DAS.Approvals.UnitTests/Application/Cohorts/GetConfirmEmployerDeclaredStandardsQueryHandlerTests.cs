...
{
    [TestFixture]
    public class GetConfirmEmployerDeclaredStandardsQueryHandlerTests
    {
        [Test, MoqAutoData]
        public async Task When_CallingParty_Have_DeclaredStandards__Then_Result_Is_False(
            GetConfirmEmployerDeclaredStandardsQuery query,
            ...
            [Frozen] Mock<IProviderStandardsService> providerStandardsService)
        {
            ...
            var handler = new GetConfirmEmployerDeclaredStandardsQueryHandler(apiClient.Object,
