...
[TestFixture]
public class GetSelectNewEmployerQueryHandlerTests
{
    [Test, MoqAutoData]
    public async Task Then_ProviderRelationships_Api_Is_Called_And_Data_Returned(
        ...
        [Frozen] Mock<ILogger<GetSelectNewEmployerQueryHandler>> logger,
        [Greedy] GetSelectNewEmployerQueryHandler handler)
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery { ProviderId = 100005067, ApprenticeshipId = 101 };
    ...
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery { ProviderId = 1, ApprenticeshipId = 1, PageNumber = 2, PageSize = 2 };
        ...
        actual.AccountProviderLegalEntities.Should().HaveCount(2);
        actual.AccountProviderLegalEntities[0].AccountLegalEntityName.Should().Be("E4");
        actual.AccountProviderLegalEntities[1].AccountLegalEntityName.Should().Be("E5");
    }
    ...
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery { ProviderId = 100005067, ApprenticeshipId = 1 };
    ...
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery { ProviderId = 100005067 };
    ...
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery { ProviderId = 100005067, ApprenticeshipId = 2 };
    ...
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery { ProviderId = 100005067, ApprenticeshipId = 3 };
    ...
    {
        // Arrange
        var query = new GetSelectNewEmployerQuery
        {
