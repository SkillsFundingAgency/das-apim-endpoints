...
namespace SFA.DAS.Approvals.UnitTests.Application.DraftApprenticeships
{
    ...
    public class GetEditDraftApprenticeshipQueryHandlerTests
    {
        ...
        private Mock<ICoursesApiClient<CoursesApiConfiguration>> _courseApiClient;
        ...
        public void Setup()
        {
            ...
            _query = fixture.Build<GetEditDraftApprenticeshipQuery>()
                .With(x => x.CourseCode, string.Empty)
                .Create();
            ...
            _courseApiClient = new Mock<ICoursesApiClient<CoursesApiConfiguration>>();
            //_courseApiClient.Setup(x=> x.Get<GetStandardRequest>(It.Is))
            ...
            _handler = new GetEditDraftApprenticeshipQueryHandler(_apiClient.Object, _deliveryModelService.Object, _courseApiClient.Object);
        }
